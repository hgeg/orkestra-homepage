...
<section id="comments">
	...
	<div class="navigation">
		<div class="nav-previous"><?php previous_comments_link( __( '<span class="meta-nav"></span> Older Comments', 'framework' ) ); ?></div>
		<div class="nav-next"><?php next_comments_link( __( 'Newer Comments <span class="meta-nav"></span>', 'framework' ) ); ?></div>
	</div> <!-- .navigation -->
	...
	<ol class="commentlist">
	 	...
	 	* See framework_comment() in functions.php for more.
	 	*/
