...
<?php $image = get_post_meta( get_the_ID(), 'of_image', true ); ?>
...
<?php if ($image) { ?>
<figure class="content-image"><a href="<?php the_permalink(); ?>"><img src="<?php echo $image; ?>" alt="<?php the_title(); ?>"/></a></figure>
<?php } ?>

<header class="entry-meta">

	<span class="format-label"><a href="<?php the_permalink() ?>" class="entry-format image"><?php _e( 'Image', 'framework' ); ?></a></span>
