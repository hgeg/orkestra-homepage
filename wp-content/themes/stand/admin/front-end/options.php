<div class="wrap" id="of_container">
	...
	<form id="of_form" method="post" action="<?php echo esc_attr( $_SERVER['REQUEST_URI'] ) ?>" enctype="multipart/form-data" >
		...
		<div id="header">
			...
			<div id="js-warning"><strong>Warning:</strong> This options panel will not work properly without javascript!</div>
		...
		*/ ?>
		...
		<div class="save_bar"> 
			...
			<img style="display:none" src="<?php echo ADMIN_DIR; ?>assets/images/loading-bottom.gif" class="ajax-loading-img ajax-loading-img-bottom" alt="Working..." />
			<?php /* <button id="of_save" type="button" class="button-primary"><?php _e('Save All Changes');?></button> */ ?>
			<input id="of_save" type="submit" class="button-primary" value="<?php _e( 'Save Settings', 'framework' ); ?>">
			<button id="of_reset" type="button" class="button submit-button reset-button" ><?php _e('Reset Options', 'framework' ); ?></button>
