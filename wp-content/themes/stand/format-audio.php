...
<?php $audio_poster = get_post_meta( get_the_ID(), 'of_audio_poster', true ); ?>
<?php $audio_mp3 = get_post_meta( get_the_ID(), 'of_audio_mp3', true ); ?>
<?php $album_cover = get_post_meta( get_the_ID(), 'of_album_cover', true ); ?>
...
<figure class="album-cover">
	<img src="<?php echo $album_cover; ?>" alt="<?php the_title(); ?>">
</figure> <!-- /end .album-cover -->
<?php } ?>

<audio id="player-audio" controls="controls">
	<source src="<?php echo $audio_mp3; ?>" type="audio/mp3">
</audio>
...
<header class="entry-meta">
	...
	<span class="format-label"><a href="<?php the_permalink() ?>" class="entry-format audio"><?php _e( 'Audio', 'framework' ); ?></a></span>
...
jQuery('audio').mediaelementplayer({
	audioWidth: <?php echo $audio_width; ?>,
	audioHeight: <?php echo $audio_height; ?>
});
</script>
